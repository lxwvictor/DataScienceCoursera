...
ui <- shinyUI(pageWithSidebar(
        headerPanel("Building a linear model to quantify the MPG difference of cars"),
        sidebarPanel(
                ...
                p('I found it was not easy to find the best set of predictors when doing the assignment 
                  of Regression Models in this data science specialization. There is a need to try 
                ...
                p('Understanding the output of this application requires some knowledge of regression 
                  models, but playing around is definitely easy. Just tick the different 
